...
void PlotLOSPath(std::vector<dem_output> *v, struct site source, struct site destination, char mask_value, FILE *fd, const struct LR LR);
...
void PlotPropagation(std::vector<dem_output> *v, struct site source, double altitude, char *plo_filename, int propmodel, int knifeedge, int haf, int pmenv,
                     bool use_threads, const struct LR LR);
